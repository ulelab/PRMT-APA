...
```{r}
df_prmt_20_15 <- df_prmt_15 %>% filter(
...
df_prmt_20_15_70 <- df_prmt_20_15 %>% 
  ...
  filter((
  (abs(mean_diff72) > 0.75*abs(mean_diffsiCFIM25) )& 
  (abs(mean_diff72) >0.75*abs(mean_diffsiELAVL1)) &  
  (abs(mean_diff72) >0.75*abs(mean_diffsiSam68) )))
