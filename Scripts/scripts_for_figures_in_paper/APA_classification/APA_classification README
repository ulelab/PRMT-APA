...
The UTR_regions_gencode_v45.bed and splice_regions_gencode_v45.bed (needs to be unzipped prior to use) generated by this script are required as input for the classification_of_APA_event.R script, and are located within this folder.
...
- The original all_polyA_sites_SAMPLE_NAME_with_change_in_usage.csv CSV files generated by drimseq.R. Examples of these files are located within the CSV_files folder, organised by figure.
