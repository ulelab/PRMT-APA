...
counts_dir <- "../../Data/Figure_2_S4/counts/panel_of_cancer_lines/"  # Directory containing count files
...
metadata_file <- "../../Data/Figure_2_S4/drimseq_panel_of_cell_lines_metadata.txt"
...
conditions_list <- list(
  'GP2D' = c('GP2D_DMSO', 'GP2D_SDMAi_ADMAi'),
  'HCT116_p53minus' = c('HCT116p53minus_DMSO', 'HCT116p53minus_SDMAi_ADMAi'),
  'HCT116_p53plus' = c('HCT116p53plus_DMSO', 'HCT116p53plus_SDMAi_ADMAi'),
  'H838' = c('H838_DMSO', 'H838_SDMAi_ADMAi'),
  'LU99' = c('LU99_DMSO', 'LU99_SDMAi_ADMAi'),
  'MCF7' = c('MCF7_DMSO', 'MCF7_SDMAi_ADMAi'),
  'PANC0403' = c('PANC0403_DMSO', 'PANC0403_SDMAi_ADMAi'),
  'SKMEL2' = c('SKMEL2_DMSO', 'SKMEL2_SDMAi_ADMAi'),
  'SUM149PT' = c('SUM149PT_DMSO', 'SUM149PT_SDMAi_ADMAi'),
  'U2OS' = c('U2OS_DMSO', 'U2OS_SDMAi_ADMAi')
...
dir.create("../../Data/Figure_2_S4/APA_CSV_files/panel_of_cancer_lines", showWarnings = FALSE)
dir.create("../../Data/Figure_2_S4/APA_CSV_files/panel_of_cancer_lines/positional_info", showWarnings = FALSE)

for (i in seq_along(condition_results)) {
  cond_name <- condition_results[[i]]$condition_name
  
  # Define output file paths
  all_sites_file <- paste0("../../Data/Figure_2_S4/APA_CSV_files/panel_of_cancer_lines/all_polyA_sites_", cond_name, "_with_change_in_usage.csv")
  sig_sites_file <- paste0("../../Data/Figure_2_S4/APA_CSV_files/panel_of_cancer_lines/sig_polyA_sites_", cond_name, "_with_change_in_usage.csv")
...
for (i in seq_along(condition_results)) {
  cond_name <- condition_results[[i]]$condition_name
  output_file <- paste0("../../Data/Figure_2_S4/APA_CSV_files/panel_of_cancer_lines/positional_info/top2_", cond_name, "_sites_with_positional_info.csv")
...
top2_colours = c('#3b753c','#3b753c','#af4325','#af4325','#af4325','#ffb2ca','#ffb2ca','#fffb7b','#20537e','#7d207e')

# reorder cell lines to place same organ cancer types next to each other
filtered_data$condition = factor(filtered_data$condition, levels = c('MCF7','SUM149PT','GP2D','HCT116_p53minus','HCT116_p53plus','H838','LU99','SKMEL2','PANC0403','U2OS'))

# Define custom labels for the x-axis and legend
x_axis_labels <- c('MCF7','SUM149PT','GP2D','HCT116 p53 -/-','HCT116 p53 +/+','NCI-H838','LU-99','SK-MEL-2','PANC0403','U2OS')  # Custom x-axis labels
