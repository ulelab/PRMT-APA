...
part_mit_sites = rbind(bed_files_with_original_coordinates[[3]],bed_files_with_original_coordinates[[4]])
no_mit_sites = rbind(bed_files_with_original_coordinates[[5]],bed_files_with_original_coordinates[[6]])

#turn back into list
all_sites = list(full_mit_sites,part_mit_sites,no_mit_sites) 
...
prefixes <- c(
  "DMAi_full_mitigation_",
  "DMAi_part_mitigation_",
  "DMAi_no_mitigation_"
)
