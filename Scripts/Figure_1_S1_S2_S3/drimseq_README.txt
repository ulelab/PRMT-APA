...
- a poly(A) site atlas file, titled merged_polya.filteredunique.annotated.bed (such as those found in the /ulelab/PRMT-APA/Data/Figure_1_S1_S2_S3/pA_atlas/ directory). This file is also generated by the nf-quantseq pipeline, and contains all poly(A) sites identified by the pipeline.
