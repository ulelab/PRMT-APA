...
# For example:
polyA_csv_dir <- "../../Data/Figure_3_S5_S6/APA_CSV_files/non_DMAi_datasets"
anno_bed_dir <- "../../Data/Figure_3_S5_S6/bed/APA_3seq/classification_of_APA_bed_files"
...
output_dir <- "../../Data/Figure_3_S5_S6/APA_CSV_files/non_DMAi_datasets/APA_classified/"
