...
## read in sig TUTR files
#read in sig DMAi cell lines TUTR sites
setwd("../../Data/Figure_2_S4/APA_CSV_files/panel_of_cancer_lines/APA_classified")
...
#read in non-DMAi condition sig TUTR sites
setwd("../../Data/Figure_3_S5_S6/APA_CSV_files/non_DMAi_datasets/APA_classified")
non_DMAi_data_frames <- list.files(
  pattern = "(?=.*sig)(?=.*TUTR).*\\.csv$",
  perl = TRUE
)
...
#read in ctrl DMAi cell lines TUTR sites
setwd("../../Data/Figure_2_S4/APA_CSV_files/panel_of_cancer_lines/APA_classified/ctrl/")
DMAi_data_frames = list.files(pattern = "*TUTR.csv")
